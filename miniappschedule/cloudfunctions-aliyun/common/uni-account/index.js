...
function parseObjectKeys(e, t) {
	...
	for (const r in e)
		if (hasOwn(e, r) && n.test(r)) {
			const n = s(r);
			e[n] = e[r], delete e[r], isPlainObject(e[n]) ? e[n] = parseObjectKeys(e[n], t) : Array.isArray(e[n]) && (e[n] = e[n]
...
function parseParams(e = {}, t) {
	...
	if (isPlainObject(t))
		for (const r in t) {
			const i = t[r];
			isFn(i) && -1 === n.indexOf(r) ? e[r] = i(e) : "string" == typeof i && -1 === n.indexOf(r) && (e[r] = e[i], s.shouldDelete
				.add(i))
		} else isFn(t) && (e = t(e));
	if (s.shouldDelete)
...
class AlipayBase {
	...
	_formatUrl(e, t) {
		let n = e;
		const s = ["app_id", "method", "format", "charset", "sign_type", "sign", "timestamp", "version", "notify_url",
	...
	_getSign(e, t) {
		...
		const r = camel2snakeJson(s),
			...
			o = crypto.createSign(ALIPAY_ALGORITHM_MAPPING[this.options.signType]).update(i, "utf8").sign(this.options.privateKey,
				"base64");
	...
	_notifyRSACheck(e, t, n) {
		...
		return crypto.createVerify(ALIPAY_ALGORITHM_MAPPING[n]).update(s, "utf8").verify(this.options.alipayPublicKey, t,
			"base64")
	}
	_checkNotifySign(e) {
		const t = e.sign;
		...
		return delete s.sign, s.sign_type = n, !!this._notifyRSACheck(s, t, n) || (delete s.sign_type, this._notifyRSACheck(
			s, t, n))
	}
	_verifyNotify(e) {
