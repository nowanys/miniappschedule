	...
	<view>
        ...
        'uni-fab--rightTop': rightTop
		  ...
		  'uni-fab__content--other-platform': !isAndroidNvue
				...
				<button :open-type="item.openType" v-for="(item, index) in content" :key="index" :class="{ 'uni-fab__item--active': isShow }" class="uni-fab__item" @click="_onItemClick(index, item)">
